...
import { BadgeCheck, ChevronDown, ClipboardList, Ellipsis, FileBarChart, 
  History, 
  LayoutDashboard, LogOut, PackageCheck, PackagePlus, Truck, UserRound, Users } from "lucide-react";
...
const AppSidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`fixed mt-15 lg:pb-0 pb-20 flex flex-col lg:mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-50 border-r border-gray-200 
    ...
    >
      <div
        className={`${isMobileOpen ? "pb-4 px-2 justify-start" : "py-5 justify-center"} flex `}
      >
        <Link to="/home">
          {
            isMobileOpen ? (
